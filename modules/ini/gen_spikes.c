...
void setBiasBits(void *spikeGenState, uint32_t chipId, uint32_t coreId, const char *biasName_t, uint8_t coarseValue,
	uint16_t fineValue, const char *lowHigh, const char *npBias);
	...
	for (chipId_t = 0; chipId_t < 1; chipId_t++) {
		...
		for (coreId = 0; coreId < 4; coreId++) {
			/*if(chipId_t == 0 && coreId == 0){
				...
				setBiasBits(state, chipId, coreId, "IF_NMDA_N", 7, 1, "HighBias", "NBias");
				setBiasBits(state, chipId, coreId, "IF_RFR_N", 2, 180, "HighBias", "NBias");
				setBiasBits(state, chipId, coreId, "IF_TAU1_N", 4, 255, "LowBias", "NBias");
				setBiasBits(state, chipId, coreId, "IF_TAU2_N", 6, 15, "HighBias", "NBias");
				setBiasBits(state, chipId, coreId, "IF_THR_N", 2, 180, "HighBias", "NBias");
			/*}else{
				setBiasBits(state, chipId, coreId, "IF_AHTAU_N", 7, 35, "LowBias", "NBias");
				setBiasBits(state, chipId, coreId, "IF_AHTHR_N", 7, 0, "HighBias", "NBias");
				setBiasBits(state, chipId, coreId, "IF_AHW_P", 7, 0, "HighBias", "PBias");
				setBiasBits(state, chipId, coreId, "IF_BUF_P", 3, 80, "HighBias", "PBias");
				setBiasBits(state, chipId, coreId, "IF_CASC_N", 7, 0, "HighBias", "NBias");
				setBiasBits(state, chipId, coreId, "IF_DC_P", 7, 0, "HighBias", "PBias");
				setBiasBits(state, chipId, coreId, "IF_NMDA_N", 7, 0, "HighBias", "NBias");
				setBiasBits(state, chipId, coreId, "IF_RFR_N", 5, 255, "HighBias", "NBias");
				setBiasBits(state, chipId, coreId, "IF_TAU1_N", 3, 200, "LowBias", "NBias");
				setBiasBits(state, chipId, coreId, "IF_TAU2_N", 6, 15, "HighBias", "NBias");
				setBiasBits(state, chipId, coreId, "IF_THR_N", 2, 40, "HighBias", "NBias");
			}*/
			setBiasBits(state, chipId, coreId, "NPDPIE_TAU_F_P", 6, 150, "HighBias", "PBias");
			setBiasBits(state, chipId, coreId, "NPDPIE_TAU_S_P", 7, 40, "HighBias", "NBias");
			setBiasBits(state, chipId, coreId, "NPDPIE_THR_F_P", 0, 220, "HighBias", "PBias");
			setBiasBits(state, chipId, coreId, "NPDPIE_THR_S_P", 7, 0, "HighBias", "PBias");
			setBiasBits(state, chipId, coreId, "NPDPII_TAU_F_P", 7, 40, "HighBias", "NBias");
			setBiasBits(state, chipId, coreId, "NPDPII_TAU_S_P", 7, 40, "HighBias", "NBias");
			setBiasBits(state, chipId, coreId, "NPDPII_THR_F_P", 7, 40, "HighBias", "PBias");
			setBiasBits(state, chipId, coreId, "NPDPII_THR_S_P", 7, 40, "HighBias", "PBias");
			setBiasBits(state, chipId, coreId, "PS_WEIGHT_EXC_F_N", 0, 250, "HighBias", "NBias");
			setBiasBits(state, chipId, coreId, "PS_WEIGHT_EXC_S_N", 7, 1, "HighBias", "NBias");
			setBiasBits(state, chipId, coreId, "PS_WEIGHT_INH_F_N", 7, 1, "HighBias", "NBias");
			setBiasBits(state, chipId, coreId, "PS_WEIGHT_INH_S_N", 7, 1, "HighBias", "NBias");
			setBiasBits(state, chipId, coreId, "PULSE_PWLK_P", 3, 50, "HighBias", "PBias");
			setBiasBits(state, chipId, coreId, "R2R_P", 4, 85, "HighBias", "PBias");
		}
	}
}
