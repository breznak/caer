...
void ResetBiases(void *spikeGenState) {
	...
	for (chipId_t = 0; chipId_t < 1; chipId_t++) {
		...
		for (coreId = 0; coreId < 4; coreId++) {
			...
			caerDynapseSetBias(state, chipId, coreId, "IF_DC_P", 5, 2, "HighBias", "PBias");
			caerDynapseSetBias(state, chipId, coreId, "IF_NMDA_N", 7, 1, "HighBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "IF_RFR_N", 2, 180, "HighBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "IF_TAU1_N", 4, 255, "LowBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "IF_TAU2_N", 6, 15, "HighBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "IF_THR_N", 2, 180, "HighBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "NPDPIE_TAU_F_P", 6, 150, "HighBias", "PBias");
			caerDynapseSetBias(state, chipId, coreId, "NPDPIE_TAU_S_P", 7, 40, "HighBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "NPDPIE_THR_F_P", 0, 220, "HighBias", "PBias");
			caerDynapseSetBias(state, chipId, coreId, "NPDPIE_THR_S_P", 7, 0, "HighBias", "PBias");
			caerDynapseSetBias(state, chipId, coreId, "NPDPII_TAU_F_P", 6, 150, "HighBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "NPDPII_TAU_S_P", 7, 40, "HighBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "NPDPII_THR_F_P", 0, 220, "HighBias", "PBias");
			caerDynapseSetBias(state, chipId, coreId, "NPDPII_THR_S_P", 7, 0, "HighBias", "PBias");
			caerDynapseSetBias(state, chipId, coreId, "PS_WEIGHT_EXC_F_N", 0, 250, "HighBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "PS_WEIGHT_EXC_S_N", 1, 250, "HighBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "PS_WEIGHT_INH_F_N", 0, 250, "HighBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "PS_WEIGHT_INH_S_N", 1, 250, "HighBias", "NBias");
			caerDynapseSetBias(state, chipId, coreId, "PULSE_PWLK_P", 3, 50, "HighBias", "PBias");
