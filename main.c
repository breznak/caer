...
static bool mainloop_1(void);
	...
	caerFrameEventPacket weightplotfeature = NULL;
	caerFrameEventPacket synapseplotfeature = NULL;
#endif
...
#ifdef ENABLE_LEARNINGFILTER
//#ifdef DYNAPSEFX2
	caerLearningFilter(5, 1, spike, &weightplotfeature, &synapseplotfeature);
//#endif
#endif
...
#endif
#ifdef ENABLE_LEARNINGFILTER
	caerVisualizer(66, "WeightFeature", &caerVisualizerRendererFrameEvents, NULL, (caerEventPacketHeader) weightplotfeature);
	caerVisualizer(67, "SynapseFeature", &caerVisualizerRendererFrameEvents, NULL, (caerEventPacketHeader) synapseplotfeature);
#endif
#endif
